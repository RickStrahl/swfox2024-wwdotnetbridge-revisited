...
**********************
***    Author: Rick Strahl
***            (c) West Wind Technologies, 1994-2024
...
***            this header file!
************************************************************************
#DEFINE WWVERSION "Version 8.0"
#DEFINE WWVERSION_NUMBER 8.0
#DEFINE WWVERSIONDATE "June 25th, 2024"
...
*** Can be used to compile the Web Connection Server without COM (if bracketed)
*** WARNING: Use with care! Make sure this .F. when compiling for COM Server deployment!
#DEFINE NO_COMSERVER_COMPILATION  	.F.
...
*** When logging Full Request and Response Size this this the 
*** Max Response body size captures
#DEFINE WWC_LOGGING_MAX_CONTENT_SIZE     50000
...
#DEFINE WWC_LOAD_WEBCONTROLSAJAX	   .F.
...
#DEFINE WWC_LOAD_WWLOCALEINFO          .F.
...
*** Flags Reference: https://docs.microsoft.com/en-us/windows/win32/wininet/api-flags
